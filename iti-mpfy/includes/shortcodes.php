    ...
    private function generate_location_main_html($name, $address, $cash, $hours, $altHours) {
            ...
            <div class="main-container">
                <div class="column-container">
                    ...
                    <p>
                        Located inside the $name, the self-service kiosk is a fast, easy way to renew vehicle registration and 
                        license plate decals and print them on the spot!
                    </p>
                    <p>Simply scan your registration renewal notice or type in your license plate number, pay your fees via 
        HTML;
            ...
            $output .= <<<HTML
                <strong>credit card</strong> or <strong>debit card</strong>, and your registration form and license plate decal prints immediately.</p>
